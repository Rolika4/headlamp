...
const useItemStyle = makeStyles(theme => ({
  link: {
    ...
    '& .MuiListItemIcon-root': {
      ...
      marginRight: (props: { fullWidth: boolean }) => (props.fullWidth ? '32px' : '0'),
    },
  ...
  linkMain: {
    ...
    '& .MuiListItem-root': {
      paddingTop: (props: { hasSubtitle: boolean }) => (props.hasSubtitle ? '0' : '8px'),
      paddingBottom: (props: { hasSubtitle: boolean }) => (props.hasSubtitle ? '0' : '8px'),
      minHeight: (props: { fullWidth: boolean }) => (!props.fullWidth ? '48px' : 'unset'),
    },
